...
public class DomesticAirbus implements AirbusInterface{
  ...
  public void book(int Seat_no)  {
    try {
      ...
      System.out.println("Seat " + Seat_no + " booked in Domestic Airbus..");
    } catch (SeatUnavailableException e) {
      System.out.println("No." + Seat_no + " Seat is Unavailable in Domestic Airbus");
    }
  }
}
